...
<body>
    ...
    <h2 class="bg-primary  pr-5 pt-5 rounded-pill position-relative"
        ...
        <button type="reset" class="btn btn-outline-primary "><a href="master.php">Home</a></button>
    </div>
        ...
        <table class="table table-hover text-center">
            ...
            <?php while($data=mysqli_fetch_array($querymenu)){ ?>
                    ...
                    <tr>
                        ...
                        <td><a href="edit.php?id=<?php echo $data['kd_produk']; ?>"> EDIT</a> | <a href="delete.php?id=<?php echo $data['kd_produk'];?>"> Delete</a> </td>
